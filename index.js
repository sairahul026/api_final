...
app.get("/", async  (req,res) =>{
    ...
    try{
        ...
        console.log(result);
         ...
         res.render("quote.ejs",{holiday:"please click button",resu:result.data,detail:"shhshsg"});
    } catch (error) {
    ...
    app.post("/", async (req, res) => {
        try {
            ...
            console.log(out);
            res.render("quote.ejs", { holiday: result.data, resu: fin_result.data, detail: out });
        } catch (error) {
            console.error(error);
        }
